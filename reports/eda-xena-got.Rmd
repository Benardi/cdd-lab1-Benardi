...
>> E diminuiu das 1as para as últimas...
...
>> Além disso, tem alguns poucos episódios com muito mais avaliações do que outros, né? É importante comentar esses pontos.
...
>> a sintaxe do do.call abaixo é meio convoluta e frágil. tenta mudar ela por verbos dplyr. vê meu exemplo no final do chunk, e substitui teu uso de do.call por essa sintaxe no restante do relatório.
...
>> Repara que como temos todos os dados (a população) dos episódios aqui, não precisamos de inferência estatística para estimar onde está a média da população. Isso seria necessário se estivéssemos estimando user_rating de cada episódio, mas na verdade nem sabemos como essa métrica é calculada. 
...
>> para ficar na sintaxe/gramática dplyr, substitui merge por left_join, e rowwise por group_by
...
>> Essa lista abaixo tem a maior cara de algo que podia ter sido automatizado, criando uma coluna que diz onde foi o maior rating. Ainda mais na hora de contar quantos % caíram em cada categoria.
